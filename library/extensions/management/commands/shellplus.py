...
from extensions.management.shells import import_objects
from extensions.management.utils import signalcommand
from extensions.management.debug_cursor import monkey_patch_cursordebugwrapper
...
class Command(BaseCommand):
    ...
    def run_notebookapp(self, app_init, options, use_kernel_specs=True, history=True):
        ...
        if 'extensions.management.notebook_extension' not in ipython_arguments:
            ipython_arguments.extend(['--ext', 'extensions.management.notebook_extension'])
    ...
    def get_idle(self, options):
        ...
        def run_idle():
            sys.argv = [
                ...
                '-c',
                """
from extensions.management import shells
