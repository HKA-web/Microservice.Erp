from hueymonitorutils.templatetags.humanize_time import human_duration
...
from hueymonitor.models import SignalInfoModel, TaskModel
...
class TaskModelAdmin(admin.ModelAdmin):
    ...
    def column_name(self, obj):
        ...
        return render_to_string(
            template_name='admin/hueymonitor/taskmodel/column_name.html',
            context=context,
        )
    ...
    def task_hierarchy_info(self, obj):
        ...
        return render_to_string(
            template_name='admin/hueymonitor/taskmodel/task_hierarchy_info.html',
            context=context,
        )
    ...
    def signals(self, obj):
        ...
        return render_to_string('admin/hueymonitor/taskmodel/field_signals.html', context)
