...
from hueymonitorutils.models.timetracking import TimetrackingBaseModel
...
from hueymonitor.constants import TASK_MODEL_DESC_MAX_LENGTH
from hueymonitor.humanize import format_sizeof, percentage, throughput
...
class TaskModel(TimetrackingBaseModel):
    ...
    def admin_link(self):
        url = reverse('admin:hueymonitor_taskmodel_change', args=[self.pk])
        return url
...
class SignalInfoModel(models.Model):
    ...
    def admin_link(self):
        url = reverse('admin:hueymonitor_signalinfomodel_change', args=[self.pk])
        return url
    ...
    class Meta:
        db_table = u'\"taskqueue\".\"task_signal\"'
