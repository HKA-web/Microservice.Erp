...
from hueymonitorutils.dbperf.query_recorder import SQLQueryRecorder
from hueymonitorutils.stacktrace import StacktraceAfter
...
class AssertQueries(SQLQueryRecorder):
    ...
    More example can be found in tests, here:
        hueymonitorutils_tests/tests/test_assert_queries.py
    """
