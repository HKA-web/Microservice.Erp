...
from . import rjsmin
from .settings import (JS_EXCLUDE_NAMESPACES, JS_GLOBAL_OBJECT_NAME,
...
def generate_js(default_urlresolver):
    ...
    js_content = loader.render_to_string('jsreverse/urls_js.tpl', {
...
def generate_cjs_module():
    return loader.render_to_string('jsreverse/urls_js.tpl', {
        'data': "false",
