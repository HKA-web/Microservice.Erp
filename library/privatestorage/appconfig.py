...
PRIVATE_STORAGE_CLASS = getattr(settings, 'PRIVATE_STORAGE_CLASS', 'privatestorage.storage.files.PrivateFileSystemStorage')
...
PRIVATE_STORAGE_AUTH_FUNCTION = getattr(settings, 'PRIVATE_STORAGE_AUTH_FUNCTION', 'privatestorage.permissions.allow_superuser')
...
PRIVATE_STORAGE_MINO_REVERSE_PROXY = getattr(settings, 'PRIVATE_STORAGE_MINO_REVERSE_PROXY', False)
