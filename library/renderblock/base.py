...
from renderblock.django import django_render_block
from renderblock.exceptions import UnsupportedEngine
...
def render_block_to_string(template_name, block_name, context=None, request=None):
    ...
    if isinstance(t, DjangoTemplate):
        ...
        from renderblock.jinja2 import jinja2_render_block
