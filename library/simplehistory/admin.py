...
class SimpleHistoryAdmin(admin.ModelAdmin):
    object_history_template = "simplehistory/object_history.html"
    object_history_form_template = "simplehistory/object_history_form.html"
    ...
    def history_view(self, request, object_id, extra_context=None):
        ...
        history = getattr(model, model._meta.simplehistory_manager_attribute)
    ...
    def history_form_view(self, request, object_id, version_id, extra_context=None):
        ...
        model = getattr(
            self.model, self.model._meta.simplehistory_manager_attribute
        ).model
