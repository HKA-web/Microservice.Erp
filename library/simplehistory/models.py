...
from simplehistory import utils
...
class HistoricalRecords:
    ...
    def finalize(self, sender, **kwargs):
        ...
        if hasattr(sender._meta, "simplehistory_manager_attribute"):
        ...
        sender._meta.simplehistory_manager_attribute = self.manager_name
    ...
    def get_extra_fields(self, model, fields):
        ...
        def revert_url(self):
            ...
            return reverse(
                f"{admin.site.name}:{app_label}_{model_name}_simplehistory",
        ...
        if instance:
            ...
            histmgr = getattr(
                ...
                getattr(
                    ...
                    "simplehistory_manager_attribute",
                    "_notthere",
                ),
                None,
            )
