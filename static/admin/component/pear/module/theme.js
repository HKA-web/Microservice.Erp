layui.define(["jquery","layer"], function (exports) {
    ...
    theme.addAlpha = function(color, opacity) {
    ...
    theme.colorSet = function(color, second) {
		...
		style += '.light-theme .pear-nav-tree .layui-this a:hover,.light-theme .pear-nav-tree .layui-this,.light-theme .pear-nav-tree .layui-this a {background-color:'+ theme.addAlpha(color, 0.5) +'!important;color:'+second+'!important;}'
