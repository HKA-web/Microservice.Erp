...
declare module DevExpress.Analytics.Utils {
	...
	export var ajaxSetup: IAjaxSetup;


	export var fetchSetup: IFetchSetup;
...
declare module DevExpress.Analytics.Internal {
	...
	export class FetchRequestManager implements IRequestManager {
	    ...
	    constructor(settings?: IRequestManagerSettings);
	    _jsonContentTypes: string[];
	    _allowedBlobContentTypes: string[];
	...
	export class DxAnalyticsComponentCommon<TOptions extends IJSDesignerBindingCommonOptions> {
	    private _element;
	    private _options;
...
declare module DevExpress.Analytics.Widgets.Internal {
	...
	export var insertOrUpdateFunctions: (functions: any | Array<IExpressionEditorFunction>, addins: any | Array<IExpressionEditorFunction>) => any;
	...
	export function combineFunctionDisplay(addins: any | Array<IExpressionEditorFunction>): Array<IExpressionEditorFunction>;
